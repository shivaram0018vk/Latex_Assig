...
\item Prove that $sin^{-1}(\frac{3}{5})-tan^{-1}(\frac{17}{31})=\frac{\pi}{4}$
...
\item Using properties of determinants, prove that:   \\
	\\
$\left| \begin{matrix} (b+c)^2 & a^2 & bc \\ (c+a)^2 & b^2 & ca \\ (a+b)^2 & c^2 & ab \end{matrix}      \right| = (a-b)(b-c)(c-a)(a+b+c)(a^2+b^2+c^2). $
\item using elementary row operations,find the inverse of thefollowing matrix:\\
	\\
A=$\myvec{2  & -1 & 3 \\ -5 & 3 & 1 \\ -3 & 2 & 3}$
...
\item Find the maximun and minimum values of $f(x)= sec x + log cos^{2}x,\\ 0<x<2\pi$.
